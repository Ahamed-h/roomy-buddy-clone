      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="font-display text-2xl font-bold text-foreground">
              aivo<span className="text-primary">.ai</span>
            </span>
          </div>
          <p className="text-muted-foreground text-sm">AI Interior Design Platform</p>
        </div>
        ...
        <Card className="glass-card-static">
          <CardContent className="p-6 space-y-6">
            ...
            <Button
              variant="outline"
              className="w-full gap-2 border-border/50 hover:border-primary/30 py-5"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={loading} className="w-full btn-premium py-5">
                {loading ? (
